...
export const metadata: Metadata = {
  title: 'Verified Priest Network | Holy Yatra',
  description:
    'Join a trusted network of verified religious service professionals. Register with Holy Yatra to connect with seeking families across India and worldwide.',
};
