...
const partnerTrustItems = [
  ...
  '247 Complete Journey Management & On-Trip Monitoring',
...
const steps: readonly BusinessStep[] = [
  ...
  },
  {
    ...
    description: 'Receive 247 live support throughout your stay until your safe departure and journey completion.',
  },
];
...
const faqs = [
  ...
  },
  {
    ...
    answer: 'Our 247 On-Trip Support team handles live itinerary adjustments, flight/train delay tracking, and rescheduled local pickups.',
  },
] as const;
    ...
    <div className={`${styles.travelContent} business-inner-page`}>
      ...
      <section className={styles.section} aria-labelledby="core-commitments-title">
        ...
        <ul className={styles.frameworkList}>
          ...
          <li>
            <BusinessPageIcon name="check" />
            <div>
              <strong>247 Responsiveness</strong>
      ...
      <section className={styles.section} id="core-services" aria-labelledby="travel-services-title">
        <header>
          ...
          <h2 id="travel-services-title">247 Complete Journey Management</h2>
          <span>
      ...
      <section className={styles.inquiry} id="inquiry" aria-labelledby="travel-inquiry-title">
        <div>
          ...
          <span>
            Share your itinerary and arrival details for custom travel planning and 247 Shadow Traveler assistance.
          </span>
        </div>
        <div className={styles.inquiryActions}>
