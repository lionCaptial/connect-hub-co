...
const nriRemoteFeatures = [
  ...
  '247 multi-lingual coordination team (English, Hindi, Regional languages).',
] as const;
...
const trustItems = [
  ...
  '247 Guided Support via Ask GenZ AI & Human Team',
] as const;
...
export function RitualServicesPage({ embedded = false }: { embedded?: boolean }) {
  return (
    <BusinessPageFrame
      ...
      embedded={embedded}
    >
      <section className={styles.section} aria-labelledby="ritual-page-title">
        <header>
      ...
      <section className={styles.aiSection} aria-labelledby="ai-section-title">
        <div>
          ...
          <h2 id="ai-section-title">Ask GenZ AI</h2>
          <p>
