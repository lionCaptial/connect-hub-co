...
export function GrievanceForm() {
  ...
  return <form className="grid gap-6" onSubmit={submit}>
    <div className="grid gap-4 rounded-xl border border-[color:var(--ch-hairline)] bg-[var(--ch-accent-soft)] p-4 sm:grid-cols-2"><label className={label}>Service Request ID *<input className={`${field} font-mono`} name="existingReference" placeholder="Enter Service / Booking Reference ID" required /></label><label className={label}>Grievance Date<input className={field} name="filingDate" type="date" /></label></div>
